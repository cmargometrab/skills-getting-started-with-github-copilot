...
activities = {
    ...
    "Soccer Team": {
        "description": "Team practice and matches to develop soccer skills",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["nina@mergington.edu", "alex@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Skill development and friendly competition in basketball",
        "schedule": "Wednesdays and Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["mason@mergington.edu", "liam@mergington.edu"]
    },
    "Painting Workshop": {
    ...
    "Drama Club": {
        "description": "Acting, stagecraft, and performance practice for school productions",
    ...
    "Debate Team": {
        ...
        "max_participants": 14,
        "participants": ["chloe@mergington.edu", "lucas@mergington.edu"]
    }
}
